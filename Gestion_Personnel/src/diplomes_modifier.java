...
public class diplomes_modifier extends JPanel {
	 ...
	 * Create the panel.
	 */
	public diplomes_modifier() {
		setSize(800,550);
		setLocation(500,150);
		setLayout(null);
		
		JLabel lblNewLabel = new JLabel("Id_Diplome");
		lblNewLabel.setBounds(40, 195, 91, 16);
		add(lblNewLabel);
		
		textField = new JTextField();
		textField.setBounds(152, 192, 116, 22);
		add(textField);
		textField.setColumns(10);
		
		JLabel lblNewLabel_1 = new JLabel("Libel\u00E9_Diplome");
		lblNewLabel_1.setBounds(40, 259, 91, 16);
		add(lblNewLabel_1);
		
		textField_1 = new JTextField();
		textField_1.setBounds(152, 256, 116, 22);
		add(textField_1);
		textField_1.setColumns(10);
		
		JLabel lblNewLabel_2 = new JLabel("Date_Obtention");
		lblNewLabel_2.setBounds(40, 330, 91, 16);
		add(lblNewLabel_2);
		
		textField_2 = new JTextField();
		textField_2.setBounds(152, 327, 116, 22);
		add(textField_2);
		textField_2.setColumns(10);
		
		JLabel lblNewLabel_3 = new JLabel("Id_Agent");
		lblNewLabel_3.setBounds(375, 195, 56, 16);
		add(lblNewLabel_3);
		
		textField_3 = new JTextField();
		textField_3.setBounds(454, 192, 116, 22);
		add(textField_3);
		textField_3.setColumns(10);
		
		JButton btn_enregistrer = new JButton("");
		btn_enregistrer.setBounds(454, 374, 97, 57);
		add(btn_enregistrer);
		...
		lblNewLabel_4.setBounds(532, 393, 97, 16);
		add(lblNewLabel_4);
	}
